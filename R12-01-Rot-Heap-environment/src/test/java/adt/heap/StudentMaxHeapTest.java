...
public class StudentMaxHeapTest {
	...
	@Test
	public void elementsByLevelTest() {
		heap.insert(40);
		heap.insert(30);
		heap.insert(35);
		heap.insert(20);
		...
		assertEquals(heap.elementsByLevel(1), new Integer[] {40});
		assertEquals(heap.elementsByLevel(2), new Integer[] {30, 35});
		heap.insert(19);
		assertEquals(heap.elementsByLevel(4), new Integer[] {19});
		
		assertEquals(heap.elementsByLevel(3), new Integer[] {20, 25, 22, 31});
